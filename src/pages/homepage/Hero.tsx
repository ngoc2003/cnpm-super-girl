...
function Hero() {
  ...
  return (
    ...
    >
      <motion.div className='opacity-0 xl:opacity-1' animate={searchBarControl}>
        ...
        <div>
          <h4 className='py-5 text-white text-4xl xxl:text-5xl font-bold max-w-[400px]'>
            QUICK START GUIDE TO USE LIBRARY
          </h4>
        </div>
        <div className='w-20 border-b-2 border-b-secondary' />
      ...
      >
        <div className='xxl:text-[85px] text-[60px] text-center text-white font-brittany'>
          Welcome to TLU
        </div>
        <div className='xxl:text-[100px] text-[80px] tracking-wide text-center text-white'>
          LIBRARY
        </div>
      </motion.div>
    </div>
